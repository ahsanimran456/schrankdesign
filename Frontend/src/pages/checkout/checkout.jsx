...
const Checkout = () => {
  ...
  const [isWiderrufsrechtModalOpen, setIsWiderrufsrechtModalOpen] =
    useState(false);
  const [isDatenschutzerklärungModalOpen, setIsDatenschutzerklärungModalOpen] =
    useState(false);
        ...
        <div className="w-1/2 ">
          ...
          <div className=" flex justify-center p-5">
            ...
            <button
              ...
              onClick={handleDatenschutzerklärung}
            >
          ...
          <div>
            ...
            {isImpressumModalOpen && (
              <ImpressumModal
                show={isImpressumModalOpen}
                handleClose={closeImpressumModalModal}
              />
            )}
          </div>
          ...
          <div>
            ...
            {isDatenschutzerklärungModalOpen && (
              <DatenschutzerklärungModal
                handleClose={closeDatenschutzerklärungModalModal}
              />
            )}
          </div>
          ...
          <div>
            {/* Modal */}
            {isVersandModalOpen && (
              <VersandModal handleClose={closeVersandModalModal} />
            )}
          </div>
