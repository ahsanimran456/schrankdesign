...
const Header = () => {
  ...
  return (
    <>
      ...
      {/* --------------------------Desktop ---------------------- */}
      <div className="bg-white sticky top-0 z-30 transition-all duration-300">
            ...
            <li className="w-full pb-4 pt-2 border-b ">
              <div className="flex items-center">
                ...
                {!mobileProduct ? (
                  ...
                  <span
                    className="ml-auto cursor-pointer"
                    onClick={() => setMobileProduct(false)}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
            ...
            <li className="w-full pb-4 pt-2 border-b ">
              <div className="flex items-center">
                ...
                {!mobileQuality ? (
                  ...
                  <span
                    className="ml-auto cursor-pointer"
                    onClick={() => setMobileQuality(false)}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
            ...
            <li className="w-full pb-4 pt-2 border-b ">
              <div className="flex items-center">
                ...
                {!serviceQuality ? (
                  <span
                    className="ml-auto cursor-pointer"
                    onClick={() => setServiceQuality(true)}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
                  ...
                  <span
                    className="ml-auto cursor-pointer"
                    onClick={() => setServiceQuality(false)}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
      ...
      >
        <div className="flex mt-2 lg:mt-5 items-center bg-white">
          ...
          <h4 className="text-base lg:text-lg font-bold ml-5">
            {storeCart && storeCart?.length
              ? `${storeCart?.length} Produkte`
              : "Warenkorb"}
          </h4>
          <button
            type="button"
