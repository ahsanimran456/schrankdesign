...
export const PlatesAccordianBefore = ({ handleToggle }) => {
  return (
    <div className="flex flex-row items-center gap-[25px]">
      <div>
        <div className="w-[50px] h-[50px]">
          <img className="w-[50px] h-[50px]" src={PlatesTest} alt="Plates_Test" />
        </div>
      </div>
...
export const PlatesAccordianAfter = ({ handleToggle }) => {
  return (
    <div className="flex flex-row gap-[25px] my-[25px] items-start h-[232px]">
      <div className="flex items-center justify-center h-full">
        <div className="w-[182px]">
          <img className="w-[182px]" src={PlatesTest} alt="Plates_TEst" />
        </div>
      </div>
